...
public class Spell2 {
	...
	public Spell2(String dictionary, String fileToCheck) throws FileNotFoundException {
...
//				System.out.println(letterInsertionString);
				...
				// print results
				System.out.println(mapElement.getValue().toString() + ": " + "Incorrect Spelling");
				System.out.println(mapElement.getValue().toString() + " => " + testString);
